...
foreground = [
        ...
        (0,(pygame.Rect((((TILE_SIZE*16), (TILE_SIZE*14)-80), (128, 380))))),
        (0,(pygame.Rect((((TILE_SIZE*16+DIFF1), (TILE_SIZE*14)-80), (128, 380))))),
        (0,(pygame.Rect((((TILE_SIZE*16+DIFF1*2), (TILE_SIZE*14)-80), (128, 380))))),
        (0,(pygame.Rect((((TILE_SIZE*16+DIFF1*3), (TILE_SIZE*14)-80), (128, 380))))),
        
        (1,(pygame.Rect((((TILE_SIZE*28), (TILE_SIZE*13)-80), (128, 380))))),
        (1,(pygame.Rect((((TILE_SIZE*28+DIFF2), (TILE_SIZE*13)-80), (128, 380))))),
        (1,(pygame.Rect((((TILE_SIZE*28+DIFF2*2), (TILE_SIZE*13)-80), (128, 380))))),
        (1,(pygame.Rect((((TILE_SIZE*28+DIFF2*3), (TILE_SIZE*13)-80), (128, 380))))),
        (1,(pygame.Rect((((TILE_SIZE*28+DIFF2*4), (TILE_SIZE*13)-80), (128, 380))))),
        (1,(pygame.Rect((((TILE_SIZE*28+DIFF2*5), (TILE_SIZE*13)-80), (128, 380))))),
        (1,(pygame.Rect((((TILE_SIZE*28+DIFF2*6), (TILE_SIZE*13)-80), (128, 380))))),
        (1,(pygame.Rect((((TILE_SIZE*28+DIFF2*7), (TILE_SIZE*13)-80), (128, 380))))),
        
        (2,(pygame.Rect((((TILE_SIZE*40), (TILE_SIZE*12)-80), (384, 380))))),
        (2,(pygame.Rect((((TILE_SIZE*40+DIFF3), (TILE_SIZE*12)-80), (384, 380))))),
        
        (3,(pygame.Rect((((TILE_SIZE*54), (TILE_SIZE*14)-80), (128, 380))))),
        (3,(pygame.Rect((((TILE_SIZE*54+DIFF4), (TILE_SIZE*14)-80), (128, 380))))),
        (3,(pygame.Rect((((TILE_SIZE*54+DIFF4*2), (TILE_SIZE*14)-80), (128, 380))))),
        (3,(pygame.Rect((((TILE_SIZE*54+DIFF4*3), (TILE_SIZE*14)-80), (128, 380))))),
        
        (4,(pygame.Rect((((TILE_SIZE*67), (TILE_SIZE*13)-80), (128, 380))))),
        (4,(pygame.Rect((((TILE_SIZE*67+DIFF5), (TILE_SIZE*13)-80), (128, 380))))),
        (4,(pygame.Rect((((TILE_SIZE*67+DIFF5*2), (TILE_SIZE*13)-80), (128, 380))))),
        (4,(pygame.Rect((((TILE_SIZE*67+DIFF5*3), (TILE_SIZE*13)-80), (128, 380))))),
        (4,(pygame.Rect((((TILE_SIZE*67+DIFF5*4), (TILE_SIZE*13)-80), (128, 380))))),
        (4,(pygame.Rect((((TILE_SIZE*67+DIFF5*5), (TILE_SIZE*13)-80), (128, 380))))),
        (4,(pygame.Rect((((TILE_SIZE*67+DIFF2*6), (TILE_SIZE*13)-80), (128, 380))))),
        (4,(pygame.Rect((((TILE_SIZE*67+DIFF5*7), (TILE_SIZE*13)-80), (128, 380))))),
        
        (5,(pygame.Rect((((TILE_SIZE*80), (TILE_SIZE*12)-80), (384, 300))))),
        (5,(pygame.Rect((((TILE_SIZE*80+DIFF6), (TILE_SIZE*12)-80), (384, 300))))),
        
        (0, (pygame.Rect((((0), (TILE_SIZE*20)), (TILE_SIZE*100, 50))))),
]

def level12inputs(variables, events, player):
...
def level12setup(foreground, camera):
    temp_dict = {}
...
def level12dialogue(variables, player):
...
Level_12 = Level(foreground, game_map, level12inputs, level12setup, level12dialogue, "3", "")