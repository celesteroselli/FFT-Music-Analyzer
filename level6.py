...
def level6inputs(variables, events, player):
    
    background = [
        (pygame.Rect((((TILE_SIZE*10), (TILE_SIZE*13)), (300, 300)))),
        (pygame.Rect((((TILE_SIZE*19), (TILE_SIZE*11)), (300, 300)))),
        (pygame.Rect((((TILE_SIZE*28), (TILE_SIZE*7)), (300, 300)))),
        (pygame.Rect((((TILE_SIZE*49), (TILE_SIZE*10)), (300, 300)))),
        (pygame.Rect((((TILE_SIZE*66), (TILE_SIZE*4)), (300, 300)))),
        (pygame.Rect((((TILE_SIZE*75), (TILE_SIZE*0)), (300, 300)))),
        (pygame.Rect((((TILE_SIZE*84), (TILE_SIZE*4)), (300, 300)))),
    ]
    ...
    foreground = [
        ...
        (pygame.Rect((((TILE_SIZE*28), (TILE_SIZE*10)+(100)-(variables["y3_height"]*factor)), (300, 50)))),
        (pygame.Rect((((TILE_SIZE*49), (TILE_SIZE*13)+(100)-(variables["y4_height"]*factor)), (300, 50)))),
        (pygame.Rect((((TILE_SIZE*66), (TILE_SIZE*7)+(100)-(variables["y5_height"]*factor)), (300, 50)))),
        (pygame.Rect((((TILE_SIZE*75), (TILE_SIZE*3)+(100)-(variables["y6_height"]*factor)), (300, 50)))),
        (pygame.Rect((((TILE_SIZE*84), (TILE_SIZE*7)+(100)-(variables["y7_height"]*factor)), (300, 50)))),
...
def level6setup(foreground, camera):
    temp_dict = {}
    ...
    temp_dict["y1_interval"] = 9/8
    temp_dict["y2_interval"] = 5/3
    temp_dict["y3_interval"] = 5/4
    temp_dict["y4_interval"] = 5/3
    temp_dict["y5_interval"] = 8/9
    temp_dict["y6_interval"] = 5/4
    temp_dict["y7_interval"] = 9/8
    temp_dict["y8_interval"] = 3/5
...
def level6dialogue(variables, player):
...
Level_6 = Level(foreground, game_map, level6inputs, level6setup, level6dialogue, "1", "")