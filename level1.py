...
def level1inputs(variables, events, player):
    ...
    foreground = [
        ...
        (pygame.Rect((((TILE_SIZE*9), (TILE_SIZE*16)+(100)-(variables["y1_height"]*1.7)), (300, 50)))),
        (pygame.Rect((((TILE_SIZE*16), (TILE_SIZE*14)+(100)-(variables["y2_height"]*1.7)), (300, 50)))),
        (pygame.Rect((((TILE_SIZE*22), (TILE_SIZE*12)+(100)-(variables["y3_height"]*1.7)), (300, 50)))),
    ]
